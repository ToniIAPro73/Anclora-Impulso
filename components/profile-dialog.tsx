    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="h-[calc(100vh-2rem)] w-[calc(100vw-3rem)] max-h-[772px] max-w-[1440px] overflow-hidden rounded-[28px] border border-orange-200/60 bg-[linear-gradient(180deg,rgba(255,251,245,0.98),rgba(255,255,255,0.96))] p-0 shadow-[0_30px_120px_rgba(15,23,42,0.35)] backdrop-blur-xl sm:max-w-none dark:border-orange-400/10 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.98),rgba(15,23,42,0.98))]">
        <div className="grid h-full grid-cols-[214px_minmax(0,1fr)]">
          <div className="flex h-full flex-col border-r border-orange-100/80 bg-[radial-gradient(circle_at_top,_rgba(251,146,60,0.22),_transparent_48%),linear-gradient(180deg,_rgba(255,247,237,0.92),_rgba(255,237,213,0.56))] px-3.5 py-3 dark:border-orange-400/10 dark:bg-[radial-gradient(circle_at_top,_rgba(251,146,60,0.12),_transparent_45%),linear-gradient(180deg,_rgba(15,23,42,0.98),_rgba(15,23,42,0.88))]">
            ...
            <div className="mt-3 flex flex-1 flex-col gap-1.5">
              ...
              <div className="grid gap-1.5">
                <div className="overflow-hidden rounded-[18px] border border-white/60 bg-white/70 p-2.5 shadow-sm dark:border-white/5 dark:bg-slate-950/45">
                ...
                <div className="overflow-hidden rounded-[18px] border border-white/60 bg-[linear-gradient(160deg,rgba(15,23,42,0.94),rgba(30,41,59,0.88))] p-2.5 text-white shadow-[0_16px_40px_rgba(15,23,42,0.28)] dark:border-white/5">
          ...
          <div className="flex h-full flex-col bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(248,250,252,0.94))] px-3.5 py-3 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.3),rgba(15,23,42,0.12))]">
            <div className="grid gap-1.5 xl:grid-cols-[minmax(0,1fr)_236px]">
              <section className="overflow-hidden rounded-[18px] border border-slate-200/80 bg-white/80 p-2.5 shadow-sm dark:border-slate-800/80 dark:bg-slate-950/45">
              ...
              <section className="overflow-hidden rounded-[18px] border border-orange-200/60 bg-[linear-gradient(180deg,rgba(255,247,237,0.92),rgba(255,237,213,0.68))] p-2.5 shadow-sm dark:border-orange-400/10 dark:bg-[linear-gradient(180deg,rgba(124,45,18,0.18),rgba(15,23,42,0.58))]">
                <div className="mb-1.5 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-slate-600 dark:text-orange-100">
            ...
            <section className="mt-1.5 grid min-h-0 flex-1 gap-1.5 xl:grid-cols-[minmax(0,1fr)_210px]">
              <div className="overflow-hidden rounded-[18px] border border-slate-200/80 bg-white/80 p-2.5 shadow-sm dark:border-slate-800/80 dark:bg-slate-950/45">
                <div className="mb-1.5 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
                  <CalendarClock className="h-4 w-4 text-orange-500" />
                  Plan sugerido
                </div>
                {recommendedPlan ? (
                  <div className="grid h-full gap-1.5 lg:grid-cols-[minmax(0,1fr)_160px]">
                    <div className="min-w-0 overflow-hidden">
                      <p className="truncate text-[14px] font-semibold tracking-tight text-slate-900 dark:text-white">{recommendedPlan.title}</p>
                      <p className="mt-0.5 line-clamp-2 text-[12px] leading-4.5 text-slate-600 dark:text-slate-400">{recommendedPlan.summary}</p>
                      <div className="mt-1.5 grid gap-1 md:grid-cols-2">
                        {weeklyPreview.map((day) => (
                          <div key={day} className="truncate rounded-[12px] border border-slate-200/80 bg-slate-50/85 px-2.5 py-1 text-[11px] text-slate-600 dark:border-slate-800/80 dark:bg-slate-900/75 dark:text-slate-300">
                            {day}
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="grid content-start gap-1.5">
                      <div className="overflow-hidden rounded-[15px] border border-slate-200/80 bg-slate-50/85 p-2 dark:border-slate-800/80 dark:bg-slate-900/75">
                        ...
                        <div className="mt-1.5 space-y-1 text-[11px] text-slate-600 dark:text-slate-300">
                          <p className="flex items-center gap-1.5 truncate"><Weight className="h-3.5 w-3.5 shrink-0 text-orange-500" /> <span className="truncate">{recommendedPlan.duration} min</span></p>
                          <p className="flex items-center gap-1.5 truncate"><Ruler className="h-3.5 w-3.5 shrink-0 text-orange-500" /> <span className="truncate">{recommendedPlan.difficulty}</span></p>
                          <p className="flex items-center gap-1.5 truncate"><Target className="h-3.5 w-3.5 shrink-0 text-orange-500" /> <span className="truncate">{recommendedPlan.workoutType}</span></p>
                        </div>
                      </div>
                      <Button asChild className="h-7 rounded-2xl bg-gradient-to-r from-orange-500 to-rose-500 px-3 text-[11px] hover:from-orange-600 hover:to-rose-600">
                        <Link href="/workouts/generate">Usar esta propuesta</Link>
                      </Button>
                    </div>
                  </div>
                ) : (
                  <div className="flex h-full items-center rounded-[15px] border border-dashed border-orange-200/80 bg-orange-50/55 p-2.5 text-[11px] leading-4.5 text-slate-600 dark:border-orange-400/10 dark:bg-orange-500/5 dark:text-slate-400">
              ...
              <div className="grid gap-1.5">
                <div className="overflow-hidden rounded-[18px] border border-slate-200/80 bg-white/80 p-2.5 shadow-sm dark:border-slate-800/80 dark:bg-slate-950/45">
                  ...
                  <div className="mt-1.5 grid gap-1">
                    <div className="overflow-hidden rounded-[12px] bg-slate-50/85 p-2 dark:bg-slate-900/75">
                ...
                <div className="overflow-hidden rounded-[18px] border border-slate-200/80 bg-[linear-gradient(160deg,rgba(255,255,255,0.9),rgba(241,245,249,0.9))] p-2.5 shadow-sm dark:border-slate-800/80 dark:bg-[linear-gradient(160deg,rgba(15,23,42,0.88),rgba(30,41,59,0.7))]">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Estado del perfil</p>
                    <p className="mt-1 text-[11px] leading-4.5 text-slate-600 dark:text-slate-400">
                      Mantiene a mano las metricas clave para ajustar recomendaciones y progresion.
                    </p>
                  </div>
                  <div className="mt-2 flex gap-1.5">
                    <Button variant="outline" className="h-7 flex-1 rounded-2xl px-2 text-[11px]" onClick={() => setOpen(false)}>
                      Cancelar
                    </Button>
                    <Button className="h-7 flex-1 rounded-2xl bg-gradient-to-r from-orange-500 to-rose-500 px-2 text-[11px] hover:from-orange-600 hover:to-rose-600" onClick={handleSave}>
                      Guardar
                    </Button>
                  </div>
                </div>
