      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-balance text-lg leading-8 text-gray-600 dark:text-gray-300">
              {t.home.subtitle}
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button
                asChild
                size="lg"
                className="bg-gradient-to-r from-orange-500 to-red-500 px-8 py-3 text-lg text-white hover:from-orange-600 hover:to-red-600"
              >
                <Link href="/auth/signup">{t.home.startJourney}</Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="bg-transparent px-8 py-3 text-lg">
