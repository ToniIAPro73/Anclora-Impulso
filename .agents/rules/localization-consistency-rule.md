...
## Norma general
Toda superficie de producto debe mantener consistencia linguistica completa dentro del idioma activo.

## Obligaciones
- No introducir literales de UI directamente en componentes si no son marca.
- Anadir cada texto nuevo en `lib/translations/es.json` y `lib/translations/en.json`.
